<script setup>
    ...
    const props = defineProps({
        isArgonConfigActive: { type: Boolean, default: false },
    } );

    const emit = defineEmits( ['argonConfigTrigger'] );

    const argonConfigClasses = computed(() =>
        props.isArgonConfigActive
            ? 'right-0'
            : '-right-90'
        );
            ...
            <div class="flex-auto p-6 pt-0 overflow-auto sm:pt-4">
                ...
                <div>
                    ...
                    <div class=" my-2 text-left">
                        <!-- Slot Sidebar Color -->
                       <slot name="sidebarColor"/>
                       <!-- End of Slot Sidebar Color -->
                    </div>
                    </a>
